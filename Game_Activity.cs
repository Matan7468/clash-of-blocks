...
namespace clash_of_blocks
{
    ...
    public class Game_Activity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Locked = new int[] { Resource.Drawable.Level1, Resource.Drawable.Level2, Resource.Drawable.Level3, Resource.Drawable.Level4 };
        ...
        public void ShowScoreDialog()
        {
            ...
            if (green > red && green > blue)
            {
                ...
                NextLvl.Click += (senderNext, eNext) =>
                {
                    ...
                    Level.SetDoneById(counter, true, sp.GetInt("userId", -1));
                    Level.SetIconById(counter, Locked[counter], sp.GetInt("userId", -1));
