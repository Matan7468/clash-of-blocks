...
namespace clash_of_blocks
{
     class AllLevels
     {
        ...
        public AllLevels(Activity activity,TextView tv,Skins s)
        {
        ...
        private void CreateLevel1()
        {
            ...
            Hint[9, 7] = 2;
            change[5, 7] = 3;
            level1 = new GameBoard(activity, change,1, tv,1,Hint, S);
            levels.Add(level1);
        }
        ...
        private void CreateLevel2()
        {
            ...
            Hint[8, 11]=2;
            change[2, 5] = 3;
            level2 = new GameBoard(activity, change,1, tv,2,Hint, S);
            levels.Add(level2);
        }
        ...
        private void Createlevel3()
        {
            ...
            change[1, 2] = 4;
            change[15, 7] = 3;
            level3 = new GameBoard(activity, change,2, tv,3,Hint,S);
            levels.Add(level3);
        }
        ...
        private void Createlevel4()
        {
            ...
            Hint[10, 10] = 2;
            change[18, 18] = 4;
            level4 = new GameBoard(activity, change,1, tv,4,Hint,S);
            levels.Add(level4);
        }
